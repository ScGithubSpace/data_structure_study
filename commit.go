...
func (s *Commit) InitLedger(ctx contractapi.TransactionContextInterface) error {
        CommitInfos := []CommitInfo{
                {Hash: "43", Tree: "4312", Parent: "412", Author: "Tom", Committer: "Tom", Msg: "commit01"},
                {Hash: "41", Tree: "6354", Parent: "534", Author: "Tom", Committer: "Tom", Msg: "commit02"},
                {Hash: "67", Tree: "5324", Parent: "754", Author: "Tom", Committer: "Tom", Msg: "commit03"},
                {Hash: "90", Tree: "5324", Parent: "291", Author: "Tom", Committer: "Tom", Msg: "commit04"},
        }
...
//写入commit信息
func (s *Commit) CreateStudentInfo(ctx contractapi.TransactionContextInterface, hash string, tree string, parent string, author string, committer string, msg string) error {
